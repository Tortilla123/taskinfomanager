...
insert into TASKS(app_name, group_id, incident_id, incident_type, summary, emp_id, submit_date, closed_date, impact, resolution, res_cate_tier_1, status, responded_date, res_cate_tier_3, target_date, maint_id, maint_ts) values
                 ...
                 ('Best Way Hub Planner', 'Intermodal EDO MF', 'INC000002923153', 'SR', 'Process Needs to be Restarted', 90909, '2019-08-12 22:38:59', '2019-08-19 22:47:53', 'LOW', 'VM Restarted', 'Application Sustainment', 'Open', '2019-08-11 22:40:14', 'Data Fix', '2019-08-11 22:40:14', 141897, '2019-08-13 19:00:00');
